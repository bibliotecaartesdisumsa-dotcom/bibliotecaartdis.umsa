...
def obtener_url_sitio():
    ...
    if settings.DEBUG:
        ...
        # Puedes tomar la primera URL permitida o usar la específica
...
def enviar_codigo_verificacion(usuario):
    ...
    try:
        ...
        # Construir mensaje de email con diseño moderno y URL dinámica
...
"""
        ...
        # No relanzamos la excepción para evitar el worker timeout
        # Simplemente retornamos None y el error se registra
        return None
